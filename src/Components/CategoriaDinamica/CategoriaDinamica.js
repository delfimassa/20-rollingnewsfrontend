    ...
    <div className="container my-5">
      ...
      <div className="row">
        {noticiasFiltradas.map((noticia) => (
          <Card key={noticia._id} className="col-12 col-sm-12 col-md-6 col-lg-4 p-0 my-2 mx-1 noticiaCard">
            <Card.Img variant="top" src={noticia.noticiaImg} />
            <Card.Body>
              <Card.Title className="font-weight-bold"><Link to={`/noticia/${noticia._id}`} style={{ color: "black", height: "100%" }}>{noticia.noticiaTitulo}</Link></Card.Title>
